...
// ============================================================================
// DJZS PROTOCOL — Architecture of Illusion (Evidence Section)
// Drop into landing page after Philosophy, before KYADemo
// ============================================================================
...
export default function ArchitectureOfIllusion() {
  ...
  return (
    <section ref={ref} id="architecture-of-illusion" className="py-20 px-4 bg-zinc-950/30">
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={tableRef}>
          ...
          <div className="hidden md:grid grid-cols-[36px_1fr_1fr_1fr] gap-[1px] mb-[1px]">
            {['#', 'PHYSICAL EVIDENCE', 'SIMULATION INTERPRETATION', 'DJZS IMPLEMENTATION'].map((h, i) => (
              <div
                key={h}
