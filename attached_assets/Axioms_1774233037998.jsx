...
// ============================================================================
// DJZS PROTOCOL — Protocol Axioms (AX-00 through AX-05)
// Extended with Holographic Substrate + Exploitation Layer axioms
// Drop into landing page: import Axioms from './components/Axioms'
// ============================================================================
...
export default function Axioms() {
  ...
  return (
    <section ref={ref} id="axioms" className="py-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-8 pt-4 border-t border-zinc-800/40 flex items-center gap-3">
          <div
            ...
            style={{ boxShadow: '0 0 6px rgba(74,222,128,0.4)', animation: 'ax-pulse 2s infinite' }}
          />
