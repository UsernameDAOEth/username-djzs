...
export function SystemArchitectureSection() {
  return (
    <section className="px-6 py-16 lg:px-12 border-t border-lime-500/20">
      <div className="max-w-6xl mx-auto space-y-8">
        <motion.h2 
          className="text-sm font-mono tracking-[0.25em] text-lime-300 uppercase"
          ...
          {SYSTEM_STEPS.map((step, index) => (
            <motion.div
              ...
              whileHover={{ 
                scale: 1.05, 
                y: -8,
                boxShadow: "0 15px 40px rgba(163,230,53,0.15)"
              }}
              className="rounded-xl border border-lime-500/40 bg-slate-950/70 p-4 shadow-md shadow-lime-950/70 cursor-pointer"
            >
